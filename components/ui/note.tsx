...
const noteVariants = cva("p-3 my-4 rounded-lg border-l-4", {
    variants: {
        variant: {
            note: "bg-slate-300/40 border-slate-400/40 dark:bg-slate-600/40 dark:border-slate-500",
            warning:
                "bg-yellow-400/40 border-yellow-400 dark:bg-yellow-600/40 dark:border-yellow-500 ",
            danger: "bg-red-400/40 border-red-400 dark:bg-red-600/40 dark:border-red-500",
            success:
                "bg-emerald-400/40 border-emerald-400 dark:bg-emerald-600/40 dark:border-emerald-500",
        },
    },
    defaultVariants: {
        variant: "note",
...
const Note: React.ForwardRefRenderFunction<HTMLDivElement, NoteProps> = (
