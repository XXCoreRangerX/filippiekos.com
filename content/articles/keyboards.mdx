...
My first group-buy purchase and the first actual custom keyboard I've built. First tactile switch build as well. I might've slightly overlubed these tactiles, but they still retain most of their original tactile bump. It's a very solid and heavy keyboard, and it feels great to type on. Been using it as my daily driver for a while now.
...
The RK61 was my first build, and my gateway into the hobby. I started off with a prebuilt and customized it a little bit myself before going all out on a fully custom keyboard, but it was already a huge upgrade over my Razer gamin keyboard I've used before that.
...
The Idobao ID80 is a 75%, integrated plate mount keyboard. I managed to get my hands on it for quite cheap locally, and it's been a pretty great board to use.
...
This is a larger version of the Model M, often referred to as the "Battlecruiser". It's a great keyboard to type on, and it has a very satisfying clicky sound. It's also built like a tank, and it's a great piece of history. I'm currently working on a custom controller board for the M122, to use it on modern computers without any converters or the like, but it's still a WIP.

#### Cherry G81-3000 HAD

I have two of these boards. Bought them solely for the keycaps, the MY switches are pretty bad. The doubleshot ABS keycaps are great though, and I've used them on a few different keyboards. This is actually quite common in the keyboard community, where people buy vintage boards to salvage some specific parts from them, which in most cases are the switches and keycaps.

#### Unbranded vintage keyboard

Found this chinese-labelled vintage keyboard listed online locally. I noticed that it had Cherry MX Black switches, so I decided to buy it. The keycaps aren't too bad either. They're rather thin, but they're doubleshot PBT, and have a decently nice texture to them. The MX Blacks are most likely the pretooled version, based off the date on the PCB.
...
I have a pretty good collection of switches, and I've tried a lot of different types from many manufacturers. Here's a list of the switches that I've tried so far.
